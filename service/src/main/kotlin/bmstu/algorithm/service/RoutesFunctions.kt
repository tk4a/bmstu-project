...
class RoutesFunctions(
    ...
    private fun checkTopRoutes(route: LinkedList<BusStopWithWeightDto>) {
        ...
        if (TOP_3_ROUTES.size > 3) {
            ...
            FileSupport.MIN_MAX_DISTANCE_BUFFER.append("MIN TOP 3 = ${top3routes[top3routes.firstKey()]}\n")
            FileSupport.MIN_MAX_DISTANCE_BUFFER.append("MAX TOP 3 = ${top3routes[top3routes.lastKey()]}\n\n")
...
//        val middleTopRoute = ALL_ROUTES_LOGS[ALL_ROUTES_LOGS.size / 2].last()
        return mutableSetOf(lastTopRoute)
    }
}
